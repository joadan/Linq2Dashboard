...
/// <summary>A metric's value over the matching rows (concept §4.4). <see cref="Value"/> is null when no row contributed.</summary>
public sealed record MetricState(string Key, string Title, Aggregation Aggregation, double? Value)
{
