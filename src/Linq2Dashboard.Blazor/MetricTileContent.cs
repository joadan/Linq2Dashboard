...
/// </summary>
/// <param name="Title">The tile's title: the builder's, or the component's override.</param>
...
public sealed record MetricTileContent(string Title, string Value, string? Share, bool IsEmpty, MetricState? Metric);
