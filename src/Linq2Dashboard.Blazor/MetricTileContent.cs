...
/// <param name="Share">The formatted share of the total when the metric has one (count, sum and distinct with a non-zero total; for the matching count, when there are rows); otherwise null.</param>
